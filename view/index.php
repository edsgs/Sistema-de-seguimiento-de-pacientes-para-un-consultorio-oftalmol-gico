<?php
    ...
    if(isset($_POST["enviar"]) and $_POST["enviar"] == "si"){ //Cuando se envie "enviar" y el post tambien sea "enviar" que sea un si
        require_once("../models/Usuario.php");
        $usuario = new Usuario();
        $usuario->login(); //Une al objeto usuario con la funcion login
    }
?>
                        ...
                        <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    ...
                                    <h1 class="h3 font-w700 mt-30 mb-10">Inicio de Sesion</h1>
                                </div>
                                ...
                                <form action="" method="post" id="loginnum1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="mt-30">
                                            <a class="link-effect text-muted mr-10 mb-5 d-inline-block" href="../registrarse/index.php">
                                                <i class="fa fa-plus mr-5"></i> Crear Cuenta
                                            </a>
                                            <a class="link-effect text-muted mr-10 mb-5 d-inline-block" href="../RecuperarContraseña/index.php">
                                                <i class="fa fa-warning mr-5"></i> Recordar Contraseña
                                            </a>
                                        </div>
                                    </div>
